...
group_by(df, Cruise) %>% 
  ...
  geom_point() +
  geom_label(aes(label = 1:5), nudge_x = 10) +
...
* Q1: Use the WOCE surface temperature and salinity maps (above) to match the profiles up to their locations based on the surface temperature and salinities in the profiles.

* Q2: Which profile/regions have the strongest and weakest pyconoclines? Why?
