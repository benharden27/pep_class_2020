...
The Zoom meetings are scheduled and available in the Google Classroom Calendar. There is also a link to the meetings on Google Classroom.
...
You will also be asked to report back from your peer discussion in a Slack channel.
...
[R for Data Science](https://r4ds.had.co.nz/) by Garrett Grolemund and Hadley Wickham. This is a greta intro text to working with data in R. I recommend reading the whole thing over the course of the summer, but I'll be assigning specific chapters in class.

We're compiling additional R resources on [this page](/r_resources) too.

In addition to the R text and reources, we have a dedicated Slack channel for R questions (and a cohort of PEP alums to answer them) and Luis Valentin as a computational advisor who will have office hours available.
